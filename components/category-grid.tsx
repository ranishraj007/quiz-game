...
import { Globe, Music, Heart, Atom, Landmark, Flag } from "lucide-react";
...
const iconMap: Record<string, React.ReactNode> = {
  ...
  country: <Flag className="w-8 h-8" />,
};
...
const colorMap: Record<string, string> = {
  ...
  country: "bg-country/20 border-country/50 hover:bg-country/30",
};
